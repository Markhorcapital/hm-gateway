...
import {
  IAlgebraV3PositionManagerABI as POSITION_MANAGER_ABI,
...
export async function removeLiquidity(
  ...
  const uniswap = await QuickSwap.getInstance(network);
...
export const removeLiquidityRoute: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post<{
    ...
    {
      schema: {
        description: 'Remove liquidity from a QuickSwap V3 position',
