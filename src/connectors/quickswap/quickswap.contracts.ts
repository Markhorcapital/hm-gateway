...
export function getQuickSwapSpender(network: string, connectorName: string): string {
  ...
  // For regular quickswap connector or any other case, use the V3 Smart Order Router
  return getQuickSwapV3SmartOrderRouterAddress(network);
}

// Re-export Uniswap ABIs since QuickSwap uses the same interfaces for V2
export { IUniswapV2PairABI, IUniswapV2FactoryABI, IUniswapV2Router02ABI } from '../uniswap/uniswap.contracts';
